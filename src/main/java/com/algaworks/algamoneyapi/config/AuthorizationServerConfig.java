...
import com.algaworks.algamoneyapi.config.token.CustomTokenEnhancerChain;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	@Bean
	public CustomTokenEnhancerChain tokenEnhancer() {
		return new CustomTokenEnhancerChain();
	}
